...
> `doc/specs/draft-asr-provider-unified.md`、`doc/specs/draft-tts-provider-unified.md`、
> `doc/specs/draft-background-agent-codex-bridge.md`（agent 插件化）
...
- [x] **N8（2026-08-16 已实现）**：summary 槽位默认换 **OpenRouter 免费视觉模型**
  ...
  - 视觉 skill（`minimax-understand-image/scripts/understand_image.py`）加
